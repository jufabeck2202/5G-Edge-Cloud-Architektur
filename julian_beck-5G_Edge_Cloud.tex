...
\subsubsection{Multi-access Edge Computing Framework}
...
\begin{itemize}  
  \item \textbf{Netzwerk Ebene:} Die unterste Ebene des Frameworks ist die Netzwerk Ebene. Sie ermöglicht die 
  Verbindung via lokalen, externen Netzwerk und über \textit{3GPP} Netzwerke, was mobile Telekommunikationstandards
  wie LTE und 5G beschreibt.
  \item \textbf{MEC Host Ebene:} Aufbauend auf der Netzwerkebene, ist die Host Ebene die Kernstruktur des Frameworks. 
  Die Ebene besteht aus Zwei Komponenten, dem MEC Host und dem MEC Managment. 
\end{itemize}
