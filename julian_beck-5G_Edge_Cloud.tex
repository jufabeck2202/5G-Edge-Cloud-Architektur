...
oder über die UPFs des Ziel und uhrsprünglichen MEC-Hosts geleited (Bild 3 in Abbildung \ref{fig:MEC_ERROR}).
\begin{figure}
...
Ping-Pong-Übergaben treten auf, wenn ein Engerät von einer Zelle zur nächsten wechselt, dann aber wieder in die uhrsprüngliche 
Zelle zurückgeht. Befindet sich ein Endgerät zwischen zwei Zellen, hat dies die Folgen, das es zwischen den zwei HOSTCHANGe
