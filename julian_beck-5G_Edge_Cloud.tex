...
Die unterste Ebene des Frameworks ist die Netzwerk Ebene. Sie ermöglicht die 
...
\subsubsection{MEC Host Ebene:}
Aufbauend auf der Netzwerkebene, ist die Host Ebene die Kernstruktur des Frameworks. 
Die Ebene besteht aus Zwei Komponenten, dem MEC Host und dem MEC Managment. 
\subsubsection{MEC System Ebene:}
...
\subsection{Beispiel eines Handoffs}
